...
//		if(comboBox_SEC.getSelectedItem().toString().compareTo("ÆÕÍ¨Íâ¿Æ") == 0) {
//			// sec="5000";
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(null, "Êý¾Ý¿âÐ´Èë³É¹¦£¡", "ÌáÊ¾",JOptionPane.INFORMATION_MESSAGE);
				} catch (SQLException e1) {
					// TODO Auto-generated catch block
					JOptionPane.showMessageDialog(null, "Êý¾Ý¿âÐ´ÈëÊ§°Ü£¡", "ÌáÊ¾", JOptionPane.ERROR_MESSAGE);
					e1.printStackTrace();
				}
//				try {
